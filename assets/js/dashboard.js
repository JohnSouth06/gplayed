...
// window.localGames est injecté depuis dashboard.php
...
function getProcessedGames() {
    ...
    // 1. Filtrage
    let filtered = window.localGames.filter(g => {
...
function edit(id) { openModal(window.localGames.find(g => g.id == id)); }
