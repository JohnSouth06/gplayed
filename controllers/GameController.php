...
class GameController
{
    ...
    public function apiGetSteamGames()
    {
        ...
        foreach ($data['response']['games'] as $steamGame) {
            // On filtre immédiatement pour ne renvoyer que les jeux qui NE SONT PAS dans la collection
            if (!$this->gameModel->checkDuplicate($_SESSION['user_id'], null, $steamGame['name'], 'PC')) {
