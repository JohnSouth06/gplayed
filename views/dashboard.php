                            ...
                            <div class="input-group mb-3">
                                ...
                                <button class="form-select text-start d-flex align-items-center rounded-start" type="button" id="trophyDropdownBtn" data-bs-toggle="dropdown" aria-expanded="false" style="max-width: 140px; cursor: pointer;"> 
                                    <span class="d-flex align-items-center w-100 overflow-hidden">
                                        ...
                                        <span class="text-truncate">Bronze</span>
                                    </span>
                                </button>
                                
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#" data-value="bronze"><img src="../assets/images/bronze.png" class="trophy-icon me-2"> Bronze</a></li>
                                    <li><a class="dropdown-item" href="#" data-value="silver"><img src="../assets/images/silver.png" class="trophy-icon me-2"> Argent</a></li>
                                    <li><a class="dropdown-item" href="#" data-value="gold"><img src="../assets/images/gold.png" class="trophy-icon me-2"> Or</a></li>
                                    <li><a class="dropdown-item" href="#" data-value="platinum"><img src="../assets/images/platinum.png" class="trophy-icon me-2"> Platine</a></li>
                                </ul>
