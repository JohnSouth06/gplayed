...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-5 gap-3 pt-2">
    ...
    <div class="d-flex gap-2 overflow-x-auto pb-2 pb-md-0" style="scrollbar-width:none;">
        <div class="stat-pill"><i class="fas fa-gamepad text-primary fs-5 me-1"></i> Total <strong><?= $totalGames ?></strong></div>
        <div class="stat-pill mx-4"><i class="fas fa-check text-success fs-5 me-1"></i> Terminés <strong><?= $finishedCount ?></strong></div>
        <div class="stat-pill"><i class="fas fa-play text-warning fs-5 me-1"></i> En cours <strong><?= $playingCount ?></strong></div>
    </div>
</div>
