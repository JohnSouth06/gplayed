...
<body class="bg-body-tertiary <?= $forceLoader ? 'loading' : '' ?>">
        ...
        <div class="loader-content">
            <div class="loader-logo-svg">
                <svg id="logo" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 240 150">
                    <defs><style>.st1 {fill: #4CE5AE;}</style></defs>
            ...
            <h5 class="fw-light mb-3 text-body">Your Gaming Story</h5>
    ...
    <div class="mobile-header d-lg-none d-flex justify-content-between">
        ...
        <span class="fw-light fs-5 align-self-center">Your Gaming Story</span>
    ...
    <nav id="sidebar">
        <div class="px-4 py-5 d-flex align-items-center justify-content-between flex-shrink-0">
            <a href="index.php" class="text-decoration-none d-block">
                ...
                <p class="fs-6 fw-light text-secondary text-center"><em>v1.0.8</em></p>
            </a>
        ...
        <div class="p-3 sidebar-scrollable">
            <ul class="nav flex-column mb-4">
                ...
                <li class="nav-item"><a href="index.php?action=home" class="nav-link <?= ($act == 'home' || $act == '') ? 'active' : '' ?>"><i class="material-icons align-middle fs-5">&#xe431;</i>Bibliothèque</a></li>
                <li class="nav-item"><a href="index.php?action=progression" class="nav-link <?= ($act == 'progression') ? 'active' : '' ?>"><i class="material-icons align-middle fs-5">&#xe6b1;</i>Journal</a></li>
                <li class="nav-item"><a href="index.php?action=stats" class="nav-link <?= ($act == 'stats') ? 'active' : '' ?>"><i class="material-icons align-middle fs-5">&#xe26b;</i>Statistiques</a></li>
                <li class="nav-item"><a href="index.php?action=community" class="nav-link <?= ($act == 'community') ? 'active' : '' ?>"><i class="material-icons align-middle fs-5">&#xf233;</i>Communauté</a></li>
                <li class="nav-item"><a href="index.php?action=feed" class="nav-link <?= ($act == 'feed') ? 'active' : '' ?>"><i class="material-icons align-middle fs-5">&#xe24c;</i>Fil d'actualités</a></li>
            </ul>
        </div>
        <div class="mx-auto">
            <script type='text/javascript' src='https://storage.ko-fi.com/cdn/widget/Widget_2.js'></script><script type='text/javascript'>kofiwidget2.init('"Soutenir le projet"', '#4ce5ae', 'Y8Y61EXO9Q');kofiwidget2.draw();</script> 
        </div>
        <div class="p-3 mt-auto flex-shrink-0" style="background-color: var(--bg-darker); border-color: rgba(255,255,255,0.05) !important;">
            <?php if (isset($_SESSION['user_id'])): ?>
                <div class="dropdown dropup">
                    ...
                    <ul class="dropdown-menu sidebar-dropdown-menu rounded-3 border-0">
                        <li><a class="sidebar-dropdown-item bg-transparent" href="index.php?action=profile"><i class="material-icons align-middle fs-5">&#xf02e;</i>Mon Profil</a></li>
                        ...
                        <li><a class="sidebar-dropdown-item text-danger" href="index.php?action=logout"><i class="material-icons align-middle fs-5">&#xe9ba;</i>Déconnexion</a></li>
                    </ul>
                </div>
            <?php endif; ?>
        </div>
    ...
    <?php endif; ?>
    <div class="main-content <?= !isset($_SESSION['user_id']) ? 'no-sidebar' : '' ?>" style="transition: margin-left 0.3s;">
    <?php require $view; ?>

    <div class="toast-container position-fixed bottom-0 end-0 p-3">
        <div id="liveToast" class="toast border-0 shadow-lg" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header bg-body border-bottom-0"><i class="material-icons align-middle text-primary me-2fs-5">&#xe88e;</i><strong class="me-auto">Notification</strong><button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button></div>
