            ...
            ?>
                <ul class="nav flex-column mb-4">
                    ...
                    <li class="nav-item"><a href="/wishlist" class="nav-link <?= ($act == 'wishlist' || $act == '') ? 'active' : '' ?>"><i class="material-icons align-middle pb-1 fs-5">&#xe8b1;</i><?= __('menu_wishlist') ?></a></li>
                     <li class="nav-item"><a href="/psn_trophies" class="nav-link <?= ($act == 'psn_trophies') ? 'active' : '' ?>"><i class="material-icons align-middle pb-1 fs-5">&#xea23;</i><?= __('menu_trophies') ?></a></li>
                ...
                <?php if (isset($_SESSION['user_id'])): ?>
                    <div class="dropdown dropup">
                        ...
                        <ul class="dropdown-menu sidebar-dropdown-menu rounded-3 border-0">
                            ...
                            <li><a class="sidebar-dropdown-item text-danger" href="/logout"><i class="material-icons align-middle fs-5">&#xe9ba;</i><?= __('menu_logout') ?></a></li>
                        </ul>
                    </div>
                <?php endif; ?>
            </div>
                    ...
                    <div class="modal-body text-center py-4">
                        ...
                        <div id="rouletteResult" class="mt-4 d-none fade-in">
                            ...
                            <div class="d-flex justify-content-center gap-2">
                                ...
                                <button class="btn btn-primary rounded-pill px-4 fw-bold shadow-sm" id="btnAcceptGame" onclick="acceptRouletteGame()"><i class="material-icons align-middle fs-6 me-1">&#xe037;</i><?= __('wheel_launch') ?></button>
                            </div>
                        </div>
