...
<head>
    ...
    <title>Gplayed • <?= __('app_title') ?></title>
    ...
    <script src="index.php?action=js_lang"></script>
</head>
...
<body class="bg-body-tertiary <?= $forceLoader ? 'loading' : '' ?>">
    ...
    <div id="app-loader">
        <div class="loader-content">
            ...
            <h5 class="fw-light mb-3 text-body"><?= __('app_title') ?></h5>
        ...
        <nav id="sidebar">
            ...
            <div class="p-3 sidebar-scrollable">
                <ul class="nav flex-column mb-4">
                    ...
                    <li class="nav-item"><a href="index.php?action=home" class="nav-link <?= ($act == 'home' || $act == '') ? 'active' : '' ?>"><i class="material-icons align-middle fs-5">&#xe431;</i><?= __('menu_library') ?></a></li>
                    <li class="nav-item"><a href="index.php?action=progression" class="nav-link <?= ($act == 'progression') ? 'active' : '' ?>"><i class="material-icons align-middle fs-5">&#xe6b1;</i><?= __('menu_journal') ?></a></li>
                    <li class="nav-item"><a href="index.php?action=stats" class="nav-link <?= ($act == 'stats') ? 'active' : '' ?>"><i class="material-icons align-middle fs-5">&#xe26b;</i><?= __('menu_stats') ?></a></li>
                    <li class="nav-item"><a href="index.php?action=community" class="nav-link <?= ($act == 'community') ? 'active' : '' ?>"><i class="material-icons align-middle fs-5">&#xf233;</i><?= __('menu_community') ?></a></li>
                    <li class="nav-item"><a href="index.php?action=feed" class="nav-link <?= ($act == 'feed') ? 'active' : '' ?>"><i class="material-icons align-middle fs-5">&#xe24c;</i><?= __('menu_feed') ?></a></li>
                </ul>
            </div>
            <div class="mx-auto">
                <script type='text/javascript' src='https://storage.ko-fi.com/cdn/widget/Widget_2.js'></script>
                <script type='text/javascript'>
                    kofiwidget2.init('<?= __('support_project') ?>', '#4ce5ae', 'Y8Y61EXO9Q');
                    kofiwidget2.draw();
                </script>
            </div>
                ...
                <?php if (isset($_SESSION['user_id'])): ?>
                    <div class="dropdown dropup">
                        ...
                        <ul class="dropdown-menu sidebar-dropdown-menu rounded-3 border-0">
                            <li><a class="sidebar-dropdown-item bg-transparent" href="index.php?action=profile"><i class="material-icons align-middle fs-5">&#xf02e;</i><?= __('menu_profile') ?></a></li>
                            ...
                            <li><a class="sidebar-dropdown-item text-danger" href="index.php?action=logout"><i class="material-icons align-middle fs-5">&#xe9ba;</i><?= __('menu_logout') ?></a></li>
                        </ul>
                    </div>
                <?php endif; ?>
            </div>
    ...
    <div class="main-content <?= !isset($_SESSION['user_id']) ? 'no-sidebar' : '' ?>" style="transition: margin-left 0.3s;">
        ...
        <div class="container-fluid py-4 mt-auto text-center">
            <small class="text-muted opacity-50">
                Gplayed &copy; <?= date('Y') ?> •
                <a href="index.php?action=legal" class="text-reset text-decoration-none"><?= __('menu_legal') ?></a>
            </small>
        </div>
