...
class Game
{
    ...
    public function importEntry($game, $userId)
    {
        ...
        if (!$internalGameId) {
            // AJOUT de platforms_list dans la requête
            $queryCatalog = "INSERT INTO games 
            (title, rawg_id, steam_appid, cover_url, genres, release_date, summary, developer, publisher, metacritic_score, platforms_list, screenshots) 
